...
namespace HotelBooking.UnitTests
{
    public class BookingManagerTests
    {
        ...
        public async Task CreateBooking_RoomAvailable_AddsBookingToRepository()
        {
            ...
            // Assert
            Assert.True(
                ((FakeBookingRepository)bookingRepository).addWasCalled);
        }
        ...
        {
            // Arrange
            var bookingRepositoryMock =
                new Mock<IRepository<Booking>>();

            var roomRepositoryMock =
                new Mock<IRepository<Room>>();
        ...
        public async Task FindAvailableRoom_RoomAvailable_ReturnsAvailableRoom()
        {
            ...
            var bookingForReturnedRoomId =
                (await bookingRepository.GetAllAsync())
                .Where(b =>
                    b.RoomId == roomId &&
                    b.StartDate <= date &&
                    b.EndDate >= date &&
        ...
        public async Task GetFullyOccupiedDates_StartDateAfterEndDate_ThrowsArgumentException()
        {
            ...
            // Act
            Task result() =>
                bookingManager.GetFullyOccupiedDates(
                    startDate,
                    endDate);
        ...
        public async Task GetFullyOccupiedDates_FullyOccupiedDate_ReturnsDate()
        {
            ...
            // Act
            var result =
                await bookingManager.GetFullyOccupiedDates(
                    date,
                    date);
